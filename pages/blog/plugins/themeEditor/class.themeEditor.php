...
class dcThemeEditor
{
	...
	public function __construct(&$core)
	{
		...
		$this->user_theme = path::real($this->core->blog->themes_path.'/'.$this->core->blog->settings->theme);
		if (null !== $this->core->themes) {
			$parent_theme = $this->core->themes->moduleInfo($this->core->blog->settings->theme,'parent');
			if ($parent_theme) {
